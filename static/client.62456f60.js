...
const scan_request = new Request('/scan'); //const signal_request = new Request('/signal');
...
function showStatus(status) {
  ...
  if (wifi_connected && document.body.classList.contains('connecting')) {
    ...
    document.body.classList.add('checking'); // let ssid_input = document.querySelector('#ssid');
  ...
  if (wifi_connected) {
    if (!document.body.classList.contains('wifi-connected') && !document.body.classList.contains('disconnecting')) {
      document.body.classList.add('wifi-connected'); //document.body.classList.add('checking');
...
async function connect_wifi(event) {
  ...
  try {
    ...
    connection_error = false; //await fetch(new Request('/connect',{method:'POST',body:formdata}))
